...
import { Role, User, UserDto } from "./model/users.js";


const i = 1
const trayan: User = new UserDto(1, 'Trayan', 'Iliev', 'trayan@gmail.com', 'trayan123', [Role.Reader, Role.Author, Role.Admin]);
